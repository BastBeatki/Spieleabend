...
export const HomeView: React.FC<HomeViewProps> = ({ sessions, navigate, setView }) => {
    ...
    <>
      <header className="text-center mb-10">
        <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Spieleabend Scoreboard</h1>
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-4 px-6 rounded-lg text-xl transition-all duration-300 shadow-[0_0_15px_rgba(99,102,241,0.4)] hover:shadow-[0_0_25px_rgba(124,58,237,0.6)] mb-6"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <button onClick={handleExport} className="w-full bg-slate-800/80 hover:bg-slate-800 border border-slate-700 text-blue-400 font-bold py-3 px-5 rounded-lg transition duration-300 flex items-center justify-center gap-2">
